      ...
      <div className="mx-auto max-w-[1560px] px-5 sm:px-8 lg:px-10">
        ...
        <Reveal>
          ...
          >
            ...
            <h2 className="mt-5 max-w-4xl text-[44px] font-black leading-[1.12] tracking-tight text-espresso sm:text-[60px] lg:text-[74px]">
              {isAr
                ? "من أول لحظة… كل شي أقرب."
                : "From the very first moment."}
            </h2>

            <p className="mt-5 max-w-2xl text-[18px] font-semibold leading-8 text-espresso/75">
              {isAr
                ? "اختيارات ناعمة ومدروسة لأيام البيبي الأولى."
                : "Soft, thoughtful essentials for their very first days."}
            </p>
          </div>
        </Reveal>
        ...
        <div className="relative overflow-hidden bg-pistachio/20">
          ...
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -bottom-7 -left-3 z-0 select-none text-[90px] font-black leading-none tracking-[-0.06em] text-espresso/[0.035] sm:text-[140px] lg:text-[190px]"
          >
            NEWBORN
          </div>
          ...
          <div className="relative z-10 grid lg:grid-cols-[1.18fr_0.82fr]">
            ...
            <a
              ...
              className="group relative min-h-[580px] overflow-hidden bg-espresso lg:min-h-[760px]"
            >
              <img
                ...
                alt={
                  isAr
                    ? "تشكيلة حديثي الولادة من OH MY BABY"
                    : "OH MY BABY newborn collection"
                }
              ...
              <div className="absolute bottom-8 left-8 text-left text-white sm:bottom-10 sm:left-10">
                ...
                <p className="mt-3 text-[28px] font-black leading-none sm:text-[34px]">
                  FROM DAY ONE
                </p>
              </div>

              {/* SMALL CORNER NUMBER */}
              <span className="absolute bottom-9 right-8 text-[11px] font-bold tracking-[0.28em] text-white/60">
                OMB / 01
              </span>
            </a>
            ...
            <div className="relative flex items-center px-7 py-16 sm:px-12 lg:px-14 lg:py-20 xl:px-16">
              <Reveal className="relative z-10 max-w-xl">
                ...
                {/* MAIN TITLE */}
                <h3 className="text-[42px] font-black leading-[1.15] tracking-tight text-espresso sm:text-[54px] lg:text-[58px]">
                  {isAr ? collection.titleAr : collection.titleEn}
                </h3>

                {/* DESCRIPTION */}
                <p className="mt-7 max-w-lg text-[19px] font-semibold leading-9 text-espresso/85">
                ...
                <div className="mt-9 flex flex-wrap gap-2.5">
                  {[
                    isAr ? "ملابس ناعمة" : "Soft Clothing",
                    isAr ? "أطقم" : "Sets",
                    isAr ? "بطانيات" : "Blankets",
                    isAr ? "إكسسوارات" : "Accessories",
                  ].map((item) => (
                    <span
                      key={item}
                      className="border border-espresso/15 bg-milk/70 px-4 py-2.5 text-[12px] font-bold text-espresso/75"
                    >
                      {item}
                    </span>
                  ))}
                ...
                <div className="mt-11 flex flex-wrap items-center gap-6">
                  <Button href={collection.href} variant="primary">
                    {isAr ? "تسوّق حديثي الولادة" : "Shop Newborn"}
                  </Button>
                ...
                <div className="mt-12 border-t border-espresso/10 pt-6">
                  <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-espresso/45">
                    OH MY BABY — LITTLE BEGINNINGS
                  </p>
                </div>
              </Reveal>
            </div>
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { id: "decor", ar: "تزيين", en: "Decor", href: "/category/decor" },
            { id: "mobility", ar: "عربايات ومقاعد", en: "Mobility", href: "/category/mobility" },
            { id: "gifts", ar: "هدايا", en: "Gifts", href: "/category/gifts" },
            { id: "baby-essentials", ar: "ألعاب ومستلزمات الطفل", en: "Toys & Essentials", href: "/category/baby-essentials" },
          ].map((item) => (
            <a key={item.id} href={item.href} className="border border-espresso/10 bg-oat/20 p-6 hover:border-aubergine/35">
              <p className="text-xs font-black uppercase tracking-[0.16em] text-aubergine/65">{isAr ? "اختيار" : "Choose"}</p>
              <h3 className="mt-2 text-xl font-black text-espresso">{isAr ? item.ar : item.en}</h3>
            </a>
          ))}
        </div>
      </div>
